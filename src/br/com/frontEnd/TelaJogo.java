	...
	public TelaJogo() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(Algoritmos.verificarResposta(alternativa4, alternativa1, alternativa2, alternativa3) == posicaoRespostaCorreta)
					JOptionPane.showConfirmDialog(null, "miserave");
				
				Algoritmos.atualizarQuestao(question, textArea, opcao1, opcao2, opcao3, opcao4);
			}
		});
